...
#healthcare
occdf <- occdf %>% mutate(
  HealthcareEmployees_A_A = 100*((S2401_C01_015E + S2401_C01_016E + S2401_C01_017E +     S2401_C01_019E)/S2401_C01_001E),
  HealthcareEmployees_F_A = 100*((S2401_C04_015E + S2401_C04_016E + S2401_C04_017E +     S2401_C04_019E)/S2401_C04_001E),
  HealthcareEmployees_M_A = 100*((S2401_C02_015E + S2401_C02_016E + S2401_C02_017E +     S2401_C02_019E)/S2401_C02_001E),
  HealthcareEmployees_A_W = 100*((C24010A_003E + C24010A_004E + C24010A_009E + C24010A_010E)/(C24010A_002E + C24010A_008E)),  
  HealthcareEmployees_A_B = 100*((C24010B_003E + C24010A_004E + C24010B_009E + C24010A_010E)/(C24010A_003E + C24010A_008E)),
  HealthcareEmployees_F_W = 100*((C24010A_009E + C24010A_010E)/(C24010A_008E)),
  HealthcareEmployees_F_B = 100*((C24010B_009E + C24010B_010E)/(C24010B_008E)),
  HealthcareEmployees_M_W = 100*((C24010A_003E + C24010A_004E)/(C24010A_002E)),
  HealthcareEmployees_M_B = 100*((C24010B_003E + C24010B_004E)/(C24010B_002E))
)

#legal employees
occdf <- occdf %>% mutate(
  LegalEmployees_A_A = 100*((S2401_C01_012E)/(S2401_C01_001E)), 
  LegalEmployees_F_A = 100*((S2401_C04_012E)/(S2401_C04_001E)),
  LegalEmployees_M_A = 100*((S2401_C02_012E)/(S2401_C02_001E)) 
)

#sales employees
occdf <- occdf %>% mutate(
  SalesEmployees_A_A = 100*((S2401_C01_027E)/(S2401_C01_001E)),
  SalesEmployees_F_A = 100*((S2401_C04_027E)/(S2401_C04_001E)), 
  SalesEmployees_M_A = 100*((S2401_C02_027E)/(S2401_C02_001E)),
  SalesEmployees_A_W = 100*((C24010A_005E + C24010A_011E)/(C24010A_003E + C24010A_008E)),
  SalesEmployees_A_B = 100*((C24010B_005E + C24010B_011E)/(C24010B_003E + C24010B_008E)), 
  SalesEmployees_F_W = 100*((C24010A_011E)/(C24010A_008E)), 
  SalesEmployees_F_B = 100*((C24010B_011E)/(C24010B_008E)), 
  SalesEmployees_M_W = 100*((C24010A_005E)/(C24010A_003E)), 
  SalesEmployees_M_B = 100*((C24010B_005E)/(C24010B_003E)) 
)

#business employees 
occdf <- occdf %>% mutate(
  BusEmployees_A_A = 100*((S2401_C01_004E + S2401_C01_005E)/(S2401_C01_001E)),
  BusEmployees_F_A = 100*((S2401_C04_004E + S2401_C04_005E)/(S2401_C04_001E)),
  BusEmployees_M_A = 100*((S2401_C02_004E + S2401_C02_005E)/(S2401_C02_001E)),
  BusEmployees_A_W = 100*((C24010A_003E + C24010A_009E)/(C24010A_002E + C24010A_008E)),  
  BusEmployees_A_B = 100*((C24010B_003E + C24010B_009E)/(C24010A_003E + C24010A_008E)),
...
#construction and extraction employees
occdf <- occdf %>% mutate(
  ConstructionEmployees_A_A = 100*((S2401_C01_031E)/(S2401_C01_001E)),
  ConstructionEmployees_F_A = 100*((S2401_C04_031E)/(S2401_C04_001E)),
  ConstructionEmployees_M_A = 100*((S2401_C02_031E)/(S2401_C02_001E)),
  ConstructionEmployees_A_W = 100*((C24010A_006E + C24010A_012E)/(C24010A_003E + C24010A_008E)), 
  ConstructionEmployees_A_B = 100*((C24010B_006E + C24010B_012E)/(C24010B_003E + C24010B_008E)),
  ConstructionEmployees_F_W = 100*((C24010A_012E)/(C24010A_008E)), 
  ConstructionEmployees_F_B = 100*((C24010B_012E)/(C24010B_008E)),
  ConstructionEmployees_M_W = 100*((C24010A_006E)/(C24010A_003E)),
  ConstructionEmployees_M_B = 100*((C24010B_006E)/(C24010B_003E))
)

#food employees 
occdf <- occdf %>% mutate(
  FoodEmployees_A_A = 100*((S2401_C01_023E)/(S2401_C01_001E)),
  FoodEmployees_F_A = 100*((S2401_C04_023E)/(S2401_C04_001E)),
  FoodEmployees_M_A = 100*((S2401_C02_023E)/(S2401_C02_001E))
)

#transportation employees 
occdf <- occdf %>% mutate(
  TransportEmployees_A_A = 100*((S2401_C01_033E)/(S2401_C01_001E)),
  TransportEmployees_F_A = 100*((S2401_C04_033E)/(S2401_C04_001E)),
  TransportEmployees_M_A = 100*((S2401_C02_033E)/(S2401_C02_001E)),
  TransportEmployees_A_W = 100*((C24010A_007E + C24010A_013E)/(C24010A_003E + C24010A_008E)),  
  TransportEmployees_A_B = 100*((C24010B_007E + C24010B_013E)/(C24010B_003E + C24010B_008E)), 
  TransportEmployees_F_W = 100*((C24010A_013E)/(C24010A_008E)), 
  TransportEmployees_F_B = 100*((C24010B_013E)/(C24010B_008E)),
  TransportEmployees_M_W = 100*((C24010A_007E)/(C24010A_003E)),
  TransportEmployees_M_B = 100*((C24010B_007E)/(C24010B_003E)) 
)
...
#used the rows for total estimates by race or gender, disregarded age ranges 
population_estimates <- population_estimates %>% mutate(
  ...
  Population_F_A = B01001_017E, #female only and all races
  Population_A_W = B01001A_001E, #all genders and white only
  Population_A_B = B01001B_001E, #all genders and black only 
...
#single households data - correct
```{r}
single_households <- getdata("S1101", "B11001", subject=TRUE)

single_households <- single_households %>% mutate(
  HH_SingleFamily_A_A = 100*((S1101_C02_009E + S1101_C03_009E + S1101_C04_009E)/S1101_C01_009E),
  HH_SingleFamily_M_A = 100*((S1101_C03_009E)/(S1101_C02_009E + S1101_C03_009E + S1101_C04_009E)),
  HH_SingleFamily_F_A = 100*((S1101_C04_009E)/(S1101_C02_009E + S1101_C03_009E + S1101_C04_009E)),
  HH_SingleFamily_A_W = 100*((B11001A_002E)/(S1101_C02_009E + S1101_C03_009E + S1101_C04_009E)),
  HH_SingleFamily_A_B = 100*((B11001B_002E)/(S1101_C02_009E + S1101_C03_009E + S1101_C04_009E)),
  HH_SingleFamily_M_W = 100*((B11001A_005E)/(S1101_C02_009E + S1101_C03_009E + S1101_C04_009E)),
  HH_SingleFamily_M_B = 100*((B11001B_005E)/(S1101_C02_009E + S1101_C03_009E + S1101_C04_009E)),
  HH_SingleFamily_F_W = 100*((B11001A_006E)/(S1101_C02_009E + S1101_C03_009E + S1101_C04_009E)),
  HH_SingleFamily_F_B = 100*((B11001B_006E)/(S1101_C02_009E + S1101_C03_009E + S1101_C04_009E))
)
...
singlehouseholds_minors <- singlehouseholds_minors %>% mutate(
  HH_W.MinorsSingleFamily_A_A = 100*((S2201_C01_010E + S2201_C01_011E)/(S2201_C01_009E)),
  HH_W.MinorsSingleFamily_F_A = 100*((S2201_C01_013E)/(S2201_C01_010E + S2201_C01_011E)),
  HH_W.MinorsSingleFamily_M_A = 100*((S2201_C01_012E)/(S2201_C01_010E + S2201_C01_011E))
)
...
govprograms_familyhouseholds <- govprograms %>% mutate(
...
allvars <- full_join(allvars, govprograms_familyhouseholds %>% select(matches("_A|_B|_W|GEOID")), by="GEOID")
...
jsonlite::write_json(combineddata, "../src/data/Data_Test_2023_07_10.json")
```
